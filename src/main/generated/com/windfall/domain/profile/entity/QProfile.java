...
public class QProfile extends EntityPathBase<Profile> {
    ...
    private static final long serialVersionUID = -255426129L;
    ...
    public final com.windfall.domain.user.entity.QUser user;
    ...
    public QProfile(Class<? extends Profile> type, PathMetadata metadata, PathInits inits) {
        ...
        this.user = inits.isInitialized("user") ? new com.windfall.domain.user.entity.QUser(forProperty("user")) : null;
    }
